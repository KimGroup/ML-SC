...
\begin{figure}
    ...
    \caption{{\bf Neural network architectures}. 
			...
			consisting of $n=40$ sigmoid neurons. 
			%Each neuron processes the input $x$ through independent weights and biases $w\cdot x+b$. 
    			(b) Deep convolutional neural network taking the unprocessed Green's functions 
				$\widetilde{P}_{jk}|_{\alpha}$ with $j$ and $k$ traversing all the lattice sites.}
