...
Another level of complexity comes from the fact that the key features revealing the nature of a collective many-fermion state 
(such as superconductors, strange metals, or non-Fermi liquids) are often their transport properties.   

In this manuscript, we build on recent progress ....
